...
describe("typeColors", () => {
    describe("getColorsByType", () => {
        it("should return the correct normal type colors", () => {
            const props = getColorsByType(typeMocks.normal.name)
        ...
        it("should return the correct fire type colors", () => {
            const props = getColorsByType(typeMocks.fire.name)
        ...
        it("should return the correct water type colors", () => {
            const props = getColorsByType(typeMocks.water.name)
        ...
        it("should return the correct electric type colors", () => {
            const props = getColorsByType(typeMocks.electric.name)
        ...
        it("should return the correct grass type colors", () => {
            const props = getColorsByType(typeMocks.grass.name)
        ...
        it("should return the correct ice type colors", () => {
            const props = getColorsByType(typeMocks.ice.name)
        ...
        it("should return the correct fighting type colors", () => {
            const props = getColorsByType(typeMocks.fighting.name)
        ...
        it("should return the correct poison type colors", () => {
            const props = getColorsByType(typeMocks.poison.name)
        ...
        it("should return the correct ground type colors", () => {
            const props = getColorsByType(typeMocks.ground.name)
        ...
        it("should return the correct flying type colors", () => {
            const props = getColorsByType(typeMocks.flying.name)
        ...
        it("should return the correct psychic type colors", () => {
            const props = getColorsByType(typeMocks.psychic.name)
        ...
        it("should return the correct bug type colors", () => {
            const props = getColorsByType(typeMocks.bug.name)
        ...
        it("should return the correct rock type colors", () => {
            const props = getColorsByType(typeMocks.rock.name)
        ...
        it("should return the correct ghost type colors", () => {
            const props = getColorsByType(typeMocks.ghost.name)
        ...
        it("should return the correct dragon type colors", () => {
            const props = getColorsByType(typeMocks.dragon.name)
        ...
        it("should return the correct dark type colors", () => {
            const props = getColorsByType(typeMocks.dark.name)
        ...
        it("should return the correct steel type colors", () => {
            const props = getColorsByType(typeMocks.steel.name)
        ...
        it("should return the correct fairy type colors", () => {
            const props = getColorsByType(typeMocks.fairy.name)
